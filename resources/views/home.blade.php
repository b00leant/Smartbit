...
<div class="row home" style="margin-bottom:0">
    ...
    border:0px;background-color: rgb(6, 86, 116);font-size:1.5em">Benvenuto</div>
        ...
        <div id="maphome" style="width:100%;height: 585px; position: relative;"></div>
    </div>
    <div style="text-align:center;padding-top:75px;padding-bottom:10px" class="grey darken-3 col s12 l4">
        <div class="fb-page" 
