...
<div class="row home" style="margin-bottom:0;padding-top:56px">
    <div class="col s12 l7" style="padding:0">
        <div class="hide welcome-banner col s12 l7" style="padding:0;position:absolute;margin-top:90px;z-index:2">
            ...
            <div class=" hour-banner smartbit-text" id="open" style="
